...
Oui — et pas en diagonale. La loi du 10 juillet 1965 organise les copropriétés françaises, mais c'est le règlement propre à chaque immeuble qui fixe les règles réelles pour votre chantier ([Légifrance](https://www.legifrance.gouv.fr/codes/section_lc/JORFTEXT000000305770/LEGISCTA000006093853/)). Trois points reviennent sur presque toutes les interventions parisiennes.
...
La salle de bains concentre souvent 20 à 30 % du budget global d'une transformation complète. Les fourchettes et contraintes spécifiques à ce poste sont détaillées dans [notre guide sur la rénovation de salle de bains à Paris](/articles/renovation-salle-de-bains-paris).

## DPE et obligation de rénovation : ce que la loi impose désormais

Avant de définir le périmètre de vos travaux, vérifiez le classement énergétique de votre logement. Depuis la loi Climat-Résilience, les règles se durcissent progressivement : les logements classés **G sont interdits à la location depuis le 1er janvier 2025**, les **F à partir de 2028**, les **E à partir de 2034** ([service-public.fr](https://www.service-public.fr/particuliers/vosdroits/F34029)). Pour un propriétaire parisien, cette contrainte peut transformer une rénovation partielle en rénovation énergétique complète — avec un impact budgétaire considérable. Un DPE réalisé en amont du chantier, et non après, permet d'arbitrer correctement entre une remise à neuf esthétique et des travaux d'isolation ou de chauffage qui conditionnent la mise en location du bien.
...
Pour 2026, les plafonds et conditions d'éligibilité sont consultables sur [anah.gouv.fr](https://www.anah.gouv.fr) et [service-public.fr](https://www.service-public.fr/particuliers/vosdroits/F19905). Les montants d'aide varient selon quatre profils de revenus (très modestes, modestes, intermédiaires, supérieurs) — vérifiez votre tranche avant d'établir votre budget prévisionnel.
...
Une entreprise générale porte la responsabilité du planning global, dispose d'artisans habitués aux contraintes parisiennes (horaires de bruit, accès restreints, règlements de syndic) et gère les relations avec le syndic et la mairie. Cette réalité est tout aussi présente dans les communes denses comme [Neuilly-sur-Seine](/neuilly-sur-seine/renovation-complete) ou [Levallois-Perret](/levallois-perret/renovation-complete) où les copropriétés imposent des règles d'accès strictes. Le surcoût de coordination tourne autour de **10 à 15 %** du montant HT des travaux.
...
MaPrimeRénov', les CEE et l'éco-PTZ sont cumulables, sous conditions. Le point clé : les travaux doivent être réalisés par un professionnel certifié RGE. Sans cette certification, vous perdez l'accès aux deux premiers dispositifs. Renseignez-vous sur [anah.gouv.fr](https://www.anah.gouv.fr) avant de choisir votre entreprise.
