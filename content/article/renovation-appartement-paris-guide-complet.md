...
description: "Rénovation légère à lourde à Paris : coûts réalistes 2026 (400 à 3 500 €/m²), autorisations PLU, règles de copropriété et erreurs à éviter avant de démarrer."
date: "2026-04-15"
lastUpdated: "2026-04-17"
slug: "renovation-appartement-paris-guide-complet"
published: true
...
> **À retenir**
> - La rénovation représente **57 % du marché du bâtiment en France**, soit 118 milliards d'euros ([FFB, 2024](https://www.ffbatiment.fr/le-batiment-en-chiffres)).
...
> - Une déclaration préalable de travaux s'instruit en **1 mois** en zone standard, **2 mois** en secteur Architectes des Bâtiments de France ([ANABF](https://www.anabf.org/vous-conseiller/vos-questions/quels-sont-les-delais-maximums-d-instruction-d-un-dossier-en-secteur-abf)).
...
Oui — et pas en diagonale. La loi du 10 juillet 1965 organise les copropriétés françaises, mais c'est le règlement propre à chaque immeuble qui fixe les règles réelles pour vos travaux ([Légifrance](https://www.legifrance.gouv.fr/codes/section_lc/JORFTEXT000000305770/LEGISCTA000006093853/)). Trois points reviennent sur presque tous les chantiers parisiens.

**Cloisons porteuses.** Leur suppression ou déplacement nécessite un vote en assemblée générale. Selon l'ANIL, les travaux touchant les parties communes requièrent la majorité de l'article 25, soit l'accord de tous les copropriétaires présents, absents et représentés ([ANIL, 2025](https://www.anil.org/votre-projet/vous-etes-proprietaire/copropriete/travaux-de-la-prise-de-decision-a-la-realisation/)).
...
**Colonnes d'eau et d'évacuation.** Toute intervention sur une colonne verticale partagée passe par une déclaration préalable au syndic, voire un vote selon les immeubles.

Depuis janvier 2025, les copropriétés de moins de 51 lots doivent adopter un Plan Pluriannuel de Travaux. Si votre immeuble est en cours de constitution de ce plan, certains travaux peuvent être conditionnés à sa validation ([service-public.fr](https://www.service-public.gouv.fr/particuliers/vosdroits/N31341)).

Le délai minimum entre la convocation et la tenue d'une assemblée générale est de 21 jours ([Décret n°67-223, art. 9](https://www.legifrance.gouv.fr/loda/id/JORFTEXT000000504696/)). Autant intégrer ce temps dans votre planning avant même de signer un devis — on a vu des chantiers bloqués six semaines faute d'anticipation.

## Quelles autorisations faut-il pour rénover à Paris ?

La réponse dépend de ce que vous touchez. Une rénovation intérieure pure (peinture, sol, cuisine, salle de bains) ne nécessite généralement aucune autorisation d'urbanisme. Mais dès qu'un élément visible depuis l'extérieur est modifié, les règles changent.
...
Depuis le **7 avril 2025**, le dépôt dématérialisé est obligatoire pour les personnes morales ([Ville de Paris](https://www.paris.fr/pages/demande-d-autorisation-d-urbanisme-3517)). Pour les particuliers, le guichet physique reste disponible en mairie d'arrondissement.

Attention aux périmètres protégés. Le Marais, l'île Saint-Louis et le 7e arrondissement sont en Secteur Sauvegardé ou à proximité de monuments classés. Dans ces zones, même certains travaux sur des éléments patrimoniaux intérieurs (escaliers, cheminées, parquets anciens) peuvent requérir l'accord de l'Architecte des Bâtiments de France.

## Combien coûte une rénovation d'appartement à Paris en 2026 ?

Il n'existe pas de barème officiel FFB ou CAPEB par type de rénovation. Les fourchettes ci-dessous reflètent les pratiques du secteur sur des appartements en état standard, hors structures dégradées. Prenez-les comme des ordres de grandeur, pas des devis.
...
Deux facteurs font systématiquement varier ces fourchettes à Paris :

**L'accessibilité du chantier.** Un appartement au 5e étage sans ascenseur génère un surcoût main d'œuvre de 8 à 12 % selon les corps de métier. La montée des matériaux, l'évacuation des gravats et les contraintes d'horaires s'additionnent.
...
**Multiplier les interlocuteurs sans coordination.** Un retard du plaquiste bloque le peintre, qui bloque le poseur de sol. Sur un appartement de 60 m², un décalage de deux semaines entre corps d'état coûte en général plus que la marge économisée en gérant soi-même.

## Vaut-il mieux tout gérer soi-même ou confier à une entreprise générale ?

Ça dépend du scope. Pour une rénovation légère (peinture + sol sur 40 m²), gérer soi-même est tout à fait faisable avec une organisation rigoureuse. Pour une rénovation complète à Paris, la coordination devient un métier en soi.

Une entreprise générale porte la responsabilité du planning global, dispose d'artisans habitués aux contraintes parisiennes (horaires de bruit, accès restreints, règlements de syndic) et gère les relations avec le syndic et la mairie. Le surcoût de coordination est généralement de **10 à 15 %** du montant HT des travaux.

Dans notre expérience sur les chantiers parisiens, ce surcoût est amorti en moins de six mois sur un chantier de rénovation complète — simplement par l'absence de temps mort entre les corps d'état et la réduction des malfaçons liées à une mauvaise interface entre artisans.
